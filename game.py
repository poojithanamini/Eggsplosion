...
#game name on tab
pygame.display.set_caption("Firstttt")

#player settings and coordinates
player_img = pygame.image.load('hen.png')
playerX = 375 #x and y coordinates  of the position of the player
playerY = 490
playerX_change = 0
...
for i in range(enemies_num):
    enemy_img.append(pygame.image.load('egg.png'))
...
def game_over_message():
    over_text = end_font.render("  ", True, (0, 0, 0))
...
def shoot_bullet(x, y):
    global bullet_state
    bullet_state = "fire"
    screen.blit(bulletImg, (x + 16, y + 10)) #see why plus 10 and plus 16
